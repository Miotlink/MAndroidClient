 ...
 * @author zhudongjie .
 */
public class FeedbackInteractor extends Interactor<String>{

    private String content;

    private PersonalInfoRepo personalInfoRepo;

    public FeedbackInteractor(JobExecutor jobExecutor, PostExecutionThread postExecutionThread,PersonalInfoRepo personalInfoRepo) {
    ...
    protected Observable<String> buildObservable() {
        return Observable.create(new Observable.OnSubscribe<String>() {
            ...
            public void call(Subscriber<? super String> subscriber) {
                try {
                    personalInfoRepo.feedback(content);
                    subscriber.onNext("");
