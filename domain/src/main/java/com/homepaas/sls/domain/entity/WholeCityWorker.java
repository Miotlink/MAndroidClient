...
/**
 * Created by JWC on 2017/1/4.
 */

public class WholeCityWorker implements IService,Serializable {
    @SerializedName("Id")
    public String id;
    ...
    public String isBusinessWorker;

    public String getIsBusinessWorker() {
        return isBusinessWorker;
    }

    public void setIsBusinessWorker(String isBusinessWorker) {
        this.isBusinessWorker = isBusinessWorker;
    }
...
//    }
    ...
    public boolean isCommonBusinessWorker() {
        if(isBusinessWorker!=null) {
            return isBusinessWorker.equals("1")?true:false;
        }
        return false;
    }
