 ...
 * @author zhudongjie .
 */
public class LikeBusinessInteractor extends Interactor<Boolean> {
    ...
    public LikeBusinessInteractor(JobExecutor jobExecutor, PostExecutionThread postExecutionThread, BusinessInfoRepo businessInfoRepo) {
    ...
    protected Observable<Boolean> buildObservable() {
        return Observable.create(new Observable.OnSubscribe<Boolean>() {
            ...
            public void call(Subscriber<? super Boolean> subscriber) {
                try {
                    boolean sucess = businessInfoRepo.likeBusiness(businessId, like);
