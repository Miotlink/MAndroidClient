...
public class CameraTools {
    ...
    public void takePhoto() {
        ...
        if (cameraIntent.resolveActivity(mContext.getPackageManager()) != null) {
            ...
            if (mContext instanceof CommonBaseActivity)
                ((CommonBaseActivity) mContext).startActivityForResult(cameraIntent, CODE_TAKE_PHOTO, null);
        } else {
    ...
    public void crop(String imagePath, int aspectX, int aspectY, int outputX, int outputY) {
        ...
        if (mContext instanceof CommonBaseActivity)
            ((CommonBaseActivity) mContext).startActivityForResult(intent, CODE_CUT, null);
