package com.homepaas.sls.update;
...
public class DownloadService extends Service {
    ...
    private String packageName = "AndroidClient.apk";
    private static boolean isDownLoad = true;//是否在下载
    private File file = new File(Environment.getExternalStorageDirectory() + "/download/" + packageName);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        receiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (longExtra == downloadId && intent.getAction().equals(DownloadManager.ACTION_DOWNLOAD_COMPLETE) && isDownLoad) {
