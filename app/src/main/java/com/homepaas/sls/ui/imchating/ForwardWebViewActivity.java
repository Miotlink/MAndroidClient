...
public class ForwardWebViewActivity extends CommonBaseActivity {

    private WebView mWebView;
    private ProgressBar mPB;
    private String targetUrl;
    private JavaScriptObject emInterface;
    ...
    protected int getLayoutId() {
        return R.layout.em_activity_forward;
    }
    ...
    protected void initView() {
        ...
        emInterface = new JavaScriptObject(this);
        ...
        mWebView.setWebChromeClient(new CommonWebChromeClient(null){
            @Override
            public void onProgressChanged(WebView view, int newProgress) {//载入进度改变而触发
                if (ForwardWebViewActivity.this.isFinishing())
                {
                    return;
                }
                if (newProgress == 100){
//                    handler.sendEmptyMessage(1);// 如果全部载入,隐藏进度对话框
        ...
        mWebView.setWebViewClient(new CommonWebClient(mWebView,this,null){
            @Override
