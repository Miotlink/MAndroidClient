 ...
 * 当前订单
 */
public class OrderCurrentFragment extends BaseListFragment<OrderEntity> implements GetOrderView, OrderActionView, HeaderViewLayout.OnRefreshListener, ClientOrderListAdapter.HostAction, BalancePayView {
    ...
    public static OrderCurrentFragment newInstance() {
    ...
    public void showError(Throwable e) {
        ...
        {
            OrderInfo orderInfo = PreferencesUtil.getObject(StaticData.ORDER_LIST_CURRENT, OrderInfo.class);
            if (orderInfo != null) {
    ...
    public void getData(boolean isShowDialog) {
        if (PreferencesUtil.getBoolean(StaticData.USER_LOGIN_STATUE)) {//用户未登录显示空布局提示
            presenter.getOrderList(StaticData.ORDER_LIST_CURRENT, isShowDialog);
        } else {
            render(null);
        }
    }
    ...
    public void onLoadMore() {
        presenter.getMoreOrderList(StaticData.ORDER_LIST_CURRENT);
    }
