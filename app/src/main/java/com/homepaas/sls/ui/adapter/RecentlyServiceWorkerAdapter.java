...
public class RecentlyServiceWorkerAdapter extends BaseRecyclerAdapter<SelectServiceOrWorkerEntity.ChooseWorkerOrMerchantInfosBean> {

    public RecentlyServiceWorkerAdapter(Context ctx) {
        super(ctx);
    }

    @Override
    public int getItemLayoutId(int viewType) {
        return R.layout.recently_service_worker;
    }
