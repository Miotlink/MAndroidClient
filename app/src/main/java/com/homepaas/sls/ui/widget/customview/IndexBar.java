package com.homepaas.sls.ui.widget.customview;
...
import com.homepaas.sls.domain.entity.BaseIndexPinyinBean;
...
//        });
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                String text = mIndexDatas.get(pressI);
                ...
                if (null != mOnIndexPressedListener) {
                    ...
                    mOnIndexPressedListener.onIndexPressed(pressI, text);
                }
                break;
    ...
    private void initSourceDatas() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            indexPinyinBean.setPycityName(pySb.toString());//设置城市名全拼音
