...
public class ReboundScrollView extends NestedScrollView {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        if (onScrollTouchEvent != null)
            onScrollTouchEvent.onEvent(ev);
        if (childView == null) {
    ...
    private OnScrollTouchEvent onScrollTouchEvent;

    public void setOnScrollTouchEvent(OnScrollTouchEvent onScrollTouchEvent) {
        this.onScrollTouchEvent = onScrollTouchEvent;
    }
