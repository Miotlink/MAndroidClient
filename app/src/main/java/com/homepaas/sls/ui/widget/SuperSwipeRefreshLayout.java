 ...
 * @description 自定义SuperSwipeRefreshLayout<br>
 * 支持下拉刷新和上拉加载更多<br>
 * 非侵入式，对原来的ListView、RecyclerView没有任何影响,用法和{@link SwipeRefreshLayout}类似。<br>
...
public class SuperSwipeRefreshLayout extends ViewGroup {
    ...
    private static final String LOG_TAG = SuperSwipeRefreshLayout.class.getSimpleName();
     ...
     * Adapter
     */
    public static class SimpleOnPullRefreshListener implements OnPullRefreshListener {
    ...
    public static class SimpleOnPushLoadMoreListener implements OnPushLoadMoreListener {
    ...
    public class CircleProgressView extends View implements Runnable {
        ...
        private static final int PERIOD = 16;// 绘制周期
