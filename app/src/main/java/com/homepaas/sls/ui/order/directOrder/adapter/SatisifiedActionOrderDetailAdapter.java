...
public class SatisifiedActionOrderDetailAdapter extends RecyclerView.Adapter<SatisifiedActionOrderDetailAdapter.ActionViewHolder> {
    ...
    public ActionViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.list_item_action_order_detail, parent, false);
