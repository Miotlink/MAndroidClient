 ...
 */
public class OrderAllFragment extends BaseListFragment<OrderEntity> implements GetOrderView, OrderActionView, HeaderViewLayout.OnRefreshListener, ClientOrderListAdapter.HostAction, BalancePayView {
    ...
    public void showError(Throwable e) {
        ...
        {
            OrderInfo orderInfo = PreferencesUtil.getObject(StaticData.ALL_ORDER_LIST, OrderInfo.class);
            if (orderInfo != null)
...
//        recyclerView.addItemDecoration(getItemDecoration());
    ...
    public void getData(boolean isShowDialog) {
        if (PreferencesUtil.getBoolean(StaticData.USER_LOGIN_STATUE)) {//用户未登录显示空布局提示
            presenter.getOrderList(StaticData.ORDER_LIST_ALL, isShowDialog);
        } else {
            render(null);
        }
    }
    ...
    public void onLoadMore() {
        presenter.getMoreOrderList(StaticData.ORDER_LIST_ALL);
    }
