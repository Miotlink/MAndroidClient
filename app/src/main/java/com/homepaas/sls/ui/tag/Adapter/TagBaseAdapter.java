...
public class TagBaseAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (isChangeStyle){
            ...
            holder.tagBtn.setMinHeight(mContext.getApplicationContext().getResources().getDimensionPixelSize(R.dimen.recharge_choose_top));
            holder.tagBtn.setMinWidth(mContext.getApplicationContext().getResources().getDimensionPixelSize(R.dimen.standard_cell_height));
            int strokeColor = Color.parseColor("#89e2dfdf");
            int fillColor = Color.parseColor("#eef2f5");
            gd.setColor(fillColor);
            gd.setStroke(1,strokeColor);
            holder.tagBtn.setBackground(gd);
            holder.tagBtn.setTextColor(ContextCompat.getColor(holder.tagBtn.getContext(),R.color.homepageServerText1));
        }
        return convertView;
    }
