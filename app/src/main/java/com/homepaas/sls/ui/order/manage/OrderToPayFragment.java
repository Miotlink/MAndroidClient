 ...
 */
public class OrderToPayFragment extends BaseListFragment<OrderEntity> implements GetOrderView, OrderActionView, HeaderViewLayout.OnRefreshListener, ClientOrderListAdapter.HostAction,BalancePayView {
    ...
    public static OrderToPayFragment newInstance() {
        OrderToPayFragment fragment = new OrderToPayFragment();
        return fragment;
    }

    public OrderToPayFragment() {
...
//        recyclerView.addItemDecoration(getItemDecoration());
    ...
    public void getData(boolean isShowDialog) {
        if (PreferencesUtil.getBoolean(StaticData.USER_LOGIN_STATUE)) {//用户未登录显示空布局提示
            presenter.getOrderList(StaticData.ORDER_LIST_TOPAY, isShowDialog);
        } else {
            render(null);
        }
    }
...
//        load();
    ...
    public void showError(Throwable e) {
        ...
        {
            OrderInfo orderInfo = PreferencesUtil.getObject(StaticData.TBC_LIST, OrderInfo.class);
            if (orderInfo != null)
    ...
    public void onLoadMore() {
        presenter.getMoreOrderList(StaticData.ORDER_LIST_TOPAY);
    }
