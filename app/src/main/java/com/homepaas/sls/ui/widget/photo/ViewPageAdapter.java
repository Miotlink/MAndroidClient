package com.homepaas.sls.ui.widget.photo;
...
public class ViewPageAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(final ViewGroup container, int position) {
        ...
        if (view == null) {
            ...
            Glide.with(context).load(images.get(position)).asBitmap().error(R.mipmap.action_dialog_default).placeholder(R.mipmap.action_dialog_default).into(new MyTarget(photoViewAttacher));
