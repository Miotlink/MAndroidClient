package com.homepaas.sls.ui.homepage_3_3_0.decroation;
...
public class TitleItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int COLOR_TITLE_BG = Color.parseColor("#EEF2F5");
    private static int COLOR_TITLE_FONT = Color.parseColor("#333639");
    private static int mTitleFontSize;//title字体大小


    public TitleItemDecoration(Context context, List<? extends CityDetail> datas) {
        super();
        mDatas = datas;
        mPaint = new Paint();
        mBounds = new Rect();
        mTitleHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 23, context.getResources().getDisplayMetrics());
...
/*
        ...
        c.drawText(mDatas.get(position).getTag(),/* child.getPaddingLeft()*/32, child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2), mPaint);
    }
    ...
    public void onDrawOver(Canvas c, final RecyclerView parent, RecyclerView.State state) {//最后调用 绘制在最上层
        ...
        c.drawText(tag, /*child.getPaddingLeft()*/32,
