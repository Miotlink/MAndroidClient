...
public class TestDFragment extends SimpleLazyLoadFragment {
    @Bind(R.id.tv_txt)
    TextView tvTxt;
    private String tag="TestDFragment";

    public static TestDFragment newInstance() {
        Bundle args = new Bundle();
        TestDFragment fragment = new TestDFragment();
