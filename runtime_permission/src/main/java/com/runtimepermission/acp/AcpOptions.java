...
//    private String mRationalMessage;
    ...
    private OnRefusePermissionListener refusePermissionListener;
...
//        mRationalMessage = builder.mRationalMessage;
        ...
        this.refusePermissionListener = builder.refusePermissionListener;
    }
...
//    }
    ...
    public OnRefusePermissionListener getRefusePermissionListener() {
        return refusePermissionListener;
    }
...
//        }
        ...
        /**
         * 拒绝权限监听
         * @param refusePermissionListener
         * @return
         */
        public Builder setRefusePermissionListener(OnRefusePermissionListener refusePermissionListener) {
            this.refusePermissionListener = refusePermissionListener;
            return this;
        }
    ...
    public interface OnRefusePermissionListener {
